...
struct LagySegmentTree{
    ...
    static LagySegmentTree<ll,ll> get_range_max(int N){
        auto f = [](ll a, ll b){return max(a,b);};
        auto g = [](ll a, ll b){return a+b;};
        return LagySegmentTree<ll,ll>(100010, f, g, g, 0, 0);
    }
};
...
int main(void)
{
    ...
    // auto f = [](ll a, ll b){return max(a,b);};
    // auto g = [](ll a, ll b){return a+b;};
    // LagySegmentTree<ll,ll> st(100010, f, g, g, 0, 0);
    auto st = LagySegmentTree<ll,ll>::get_range_max(100010);
    vector<pii> ST(N);
    REP(i, N){
        int s,t;
        cin >> s >> t;
