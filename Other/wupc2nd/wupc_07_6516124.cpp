...
int main(void)
{
    ...
    REP(i, M){
        ...
        if(s=="challenge"){
            ...
            int ub = bit.lower_bound(min(arg + H, bit.sum(N+M)));
            // int ub = bit.lower_bound(arg + H);
            if(arg - H >= bit.sum(N+M)){
                pr("miss");
            }else if(lb == ub){
                pr("go");
    ...
    //         v1 = bit.sum(lb);
    //         v2 = bit.sum(ub);
    //         if(v1 <= (arg - H) && v2 <= (arg - H)){
    //             pr("miss");
    //         }
    //         else if(((v1 <= (arg - H) && (arg + H) <= v2)) || (v1 <= (arg - H) && ub == N)){
    //             pr("go");
    //             bit.add(ub, -(v2-v1));
    //         } 
    //         // else if(v1 > (arg - H) || (arg + H) > v2){
    //         else{
    //             pr("stop");
    //         }
    //     }else{
